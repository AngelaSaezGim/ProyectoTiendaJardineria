 ...
 * @author angsaegim
 */
public class TiendaAppUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iniciarPrograma.setBackground(new java.awt.Color(204, 204, 255));
        iniciarPrograma.setText("Comenzar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiendaAppUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TiendaAppUI().setVisible(true);
            }
        });
    }
